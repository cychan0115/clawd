...
- ✅ wing_1 Git clean
- ✅ clawd Git clean (本地已 commit，push 失败)
- ⚠️ GitHub 远程仓库不可用
- ✅ task_state_manager: No active task
- **当前没有待处理的 Jira 任务。**
